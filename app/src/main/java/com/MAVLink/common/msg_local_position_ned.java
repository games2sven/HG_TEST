...
public class msg_local_position_ned extends MAVLinkMessage {
    ...
    */
    ...
    /**
    * Flying total time (second)
    */
    public long flying_total_time;
      
    /**
    * Flying total distance (meter)
    */
    public long flying_total_distance;
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.payload.putUnsignedInt(flying_total_time);
              
        packet.payload.putUnsignedInt(flying_total_distance);
    ...
    */
    public void unpack(MAVLinkPayload payload) {
        ...
        this.flying_total_time = payload.getUnsignedInt();
              
        this.flying_total_distance = payload.getUnsignedInt();
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_LOCAL_POSITION_NED -"+" time_boot_ms:"+time_boot_ms+" flying_total_time:"+flying_total_time+" flying_total_distance:"+flying_total_distance+" x:"+x+" y:"+y+" z:"+z+" vx:"+vx+" vy:"+vy+" vz:"+vz+"";
    }
}
