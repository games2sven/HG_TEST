...
// MESSAGE SAFETY_NO_FLY_ZONE PACKING
...
* safety no fly zone.
*/
public class msg_safety_no_fly_zone extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_SAFETY_NO_FLY_ZONE = 57;
    public static final int MAVLINK_MSG_LENGTH = 174;
    private static final long serialVersionUID = MAVLINK_MSG_ID_SAFETY_NO_FLY_ZONE;
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_SAFETY_NO_FLY_ZONE;
    ...
    /**
    * Decode a safety_no_fly_zone message into this class fields
    *
    ...
    */
    public msg_safety_no_fly_zone(){
        msgid = MAVLINK_MSG_ID_SAFETY_NO_FLY_ZONE;
    }
    ...
    *
    */
    public msg_safety_no_fly_zone(MAVLinkPacket mavLinkPacket){
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_SAFETY_NO_FLY_ZONE;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_SAFETY_NO_FLY_ZONE -"+" begin_at:"+begin_at+" end_at:"+end_at+" updated_at:"+updated_at+" area_id:"+area_id+" lat:"+lat+" lon:"+lon+" randius:"+randius+" polygon_lat:"+polygon_lat+" polygon_lon:"+polygon_lon+" frame:"+frame+" country:"+country+" level:"+level+" shape:"+shape+" type:"+type+"";
    }
}
