...
public class msg_param_set extends MAVLinkMessage {
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_PARAM_SET -"+" param_value:"+param_value+" target_system:"+target_system+" target_component:"+target_component+" param_id:"+ Arrays.toString(param_id)+" param_type:"+param_type+"";
    }
}
