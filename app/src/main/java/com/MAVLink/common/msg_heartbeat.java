...
public class msg_heartbeat extends MAVLinkMessage {
    ...
    /**
    * A bitfield for use for function switch flags.
    */
    public long function_switch;
      
    /**
    * A bitfield for use for flying info flags.
    */
    public long flying_info;
    ...
    */
    ...
    /**
    * Flight mode, see MAV_FLIGHT_MODE ENUM
    */
    public short flight_mode;
      
    /**
    * System status, see MAV_STATE ENUM
    */
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.payload.putUnsignedInt(function_switch);
              
        packet.payload.putUnsignedInt(flying_info);
              
        packet.payload.putUnsignedByte(type);
              
        packet.payload.putUnsignedByte(autopilot);
              
        packet.payload.putUnsignedByte(flight_mode);
    ...
    */
    public void unpack(MAVLinkPayload payload) {
        ...
        this.function_switch = payload.getUnsignedInt();
              
        this.flying_info = payload.getUnsignedInt();
              
        this.type = payload.getUnsignedByte();
              
        this.autopilot = payload.getUnsignedByte();
              
        this.flight_mode = payload.getUnsignedByte();
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_HEARTBEAT -"+" function_switch:"+function_switch+" flying_info:"+flying_info+" type:"+type+" autopilot:"+autopilot+" flight_mode:"+flight_mode+" system_status:"+system_status+" mavlink_version:"+mavlink_version+"";
    }
}
